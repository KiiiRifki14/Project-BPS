...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --login-bg-from: var(--color-primary-900);
            /* #002D5C */
            --login-bg-mid: var(--color-primary);
            /* #0057A8 */
            --login-bg-to: var(--color-primary-700);
            /* #004A9E */
        }
    ...
    <div class="login-container">
        ...
        <div class="login-brand">
            ...
            <div class="feature-list">
                <div class="feature-item"><span class="feature-icon">📂</span> Multi-file upload SPJ, BAPP &amp;
                    Kuitansi</div>
                ...
                <div class="feature-item"><span class="feature-icon">🌳</span> Navigasi hirarki POK 7-level dinamis
                </div>
        ...
        <div class="login-form-card">
            ...
            @if ($errors->any())
                <div class="sakdi-alert sakdi-alert-error mb-4" role="alert">
                    <svg class="sakdi-alert-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        aria-hidden="true">
            ...
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nip_username" name="nip_username"
                        ...
                        autocomplete="username" aria-describedby="{{ $errors->has('nip_username') ? 'nip-error' : '' }}"
                        required>
                    @error('nip_username')
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password"
                        class="form-input {{ $errors->has('password') ? 'input-error' : '' }}" placeholder="••••••••"
                        autocomplete="current-password"
                        aria-describedby="{{ $errors->has('password') ? 'pw-error' : '' }}" required>
                    @error('password')
            ...
            <div class="demo-card">
                ...
                <div class="demo-list">
                    ...
                    <div>🔵 <code class="demo-code">supervisor</code> / <code class="demo-code">super123</code> —
                        Supervisor</div>
                    <div>🟢 <code class="demo-code">operator</code> / <code class="demo-code">oper123</code> —
                        Operator</div>
                    <div>🟡 <code class="demo-code">bendahara</code> / <code class="demo-code">bend123</code> —
                        Bendahara</div>
                </div>
            </div>
        </div>
